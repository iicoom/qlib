...
if __name__ == "__main__":
    print("正在初始化QLib...")
    init_success = init_qlib()
    
    # 调试数据加载
    debug_data_loading("SZ002837")
    
    # 从QLib加载数据
    print("\n正在从QLib加载SZ002837数据...")
    df = load_qlib_data("SZ002837", count=20)
    ...
    print(f"开始预测SZ002837在{latest_date}后下一个交易日的股价...\n")
    ...
    print(f"📈 SZ002837 最终集成预测: {final_prediction:.2f}")
